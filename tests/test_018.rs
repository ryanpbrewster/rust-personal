...
use project_euler::problems::problem_018;
...
fn small() {
    ...
    assert_eq!(problem_018::solve(t), 23);
}
...
fn main() {
    ...
    let t = Triangle::new(vec![75, 95, 64, 17, 47, 82, 18, 35, 87, 10, 20, 04, 82, 47, 65, 19,
    ...
    assert_eq!(problem_018::solve(t), 1074);
}
